...
const Page = () => {
  const lastData = useData()
  let last = null

  if (lastData && lastData.data  && lastData.data.events) {
  lastData.data.events.sort((a, b) => new Date(b.date) - new Date(a.date));
  ...
  return <>
    ...
    <main>
      ...
      <section className="EventsContainer">
        <h2 className="Title" id="nos-realisations" data-testid="event-section-title">Nos réalisations</h2>
        <EventList />
      </section>
